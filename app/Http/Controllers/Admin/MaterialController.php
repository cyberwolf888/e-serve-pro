...
class MaterialController extends Controller
{
    ...
    public function index(SchoolClass $class): View
    {
        ...
        return view('admin.materials.index', ['class' => $class, 'materials' => $this->repo->forClass($class)]);
    }
    ...
    public function create(SchoolClass $class): View
    {
        ...
        return view('admin.materials.create', ['class' => $class]);
    }
    ...
    public function store(StoreMaterialRequest $request, SchoolClass $class): RedirectResponse
    {
        ...
        return to_route('admin.classes.materials.index', $class)->with('success', 'Materi berhasil ditambahkan.');
    }
    ...
    public function edit(SchoolClass $class, Material $material): View
    {
        ...
        return view('admin.materials.edit', ['class' => $class, 'material' => $material]);
    }
    ...
    public function update(UpdateMaterialRequest $request, SchoolClass $class, Material $material): RedirectResponse
    {
        ...
        return to_route('admin.classes.materials.index', $class)->with('success', 'Materi berhasil diperbarui.');
    }
    ...
    public function destroy(SchoolClass $class, Material $material): RedirectResponse
    {
        ...
        return to_route('admin.classes.materials.index', $class)->with('success', 'Materi berhasil dihapus.');
    }
}
