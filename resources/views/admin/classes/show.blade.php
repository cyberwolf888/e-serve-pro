...
<div class="grid gap-5 lg:gap-7.5">
    ...
    <div class="kt-card">
        <div class="kt-card-header flex items-center justify-between">
            <h3 class="kt-card-title text-sm">Materi ({{ $class->materials->count() }})</h3>
            <a href="{{ route('admin.classes.materials.index', $class) }}" class="kt-btn kt-btn-sm kt-btn-outline">Kelola Materi</a>
        </div>
        <div class="kt-card-content p-0">
            <table class="kt-table table-auto kt-table-border">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="kt-badge kt-badge-outline">{{ $material->type === 'figma' ? 'Tautan' : 'PDF' }}</span></td>
                    </tr>
                    @empty
                    <tr><td colspan="2" class="py-8 text-center text-sm text-secondary-foreground">Belum ada materi.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
