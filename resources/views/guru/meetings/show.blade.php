{{-- guru/meetings/show.blade.php — FR-GR-06 / FR-GR-07 / FR-GR-08 / FR-SA-03 / NFR-08 / M4 / ADMIN_CLASS_ACCESS_PLAN --}}
@extends('layouts.app')
...
<div class="grid gap-5 lg:gap-7.5 py-6 xl:w-[38.75rem] mx-auto">
    <div class="flex items-center gap-3">
        <a href="{{ route($routePrefix.'.classes.meetings.index', $class) }}" class="kt-btn kt-btn-ghost kt-btn-icon"><i class="ki-filled ki-arrow-left text-lg"></i></a>
    ...
    <div class="kt-card">
        <div class="kt-card-content grid gap-2 p-7.5">
            ...
            <a href="{{ route($routePrefix.'.classes.meetings.attendance.edit', [$class, $meeting]) }}" class="kt-btn kt-btn-outline kt-btn-primary self-start">
    ...
    <div class="kt-card">
        ...
        <form method="POST" action="{{ route($routePrefix.'.classes.meetings.share', [$class, $meeting]) }}">
            @csrf
