{{-- guru/classes/index.blade.php — FR-GR-02 / NFR-08 / M3 --}}
@extends('layouts.app')
...
<div class="grid gap-5 lg:gap-7.5">
    ...
    <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-2">
        <div class="flex flex-col justify-center gap-2">
            <h1 class="text-xl font-medium leading-none text-mono">Kelas Saya</h1>
        ...
        <div class="flex items-center gap-2.5">
            <a href="{{ route('guru.classes.create') }}" class="kt-btn kt-btn-primary">
                                        ...
                                        <div class="kt-menu flex-inline" data-kt-menu="true">
                                            <div class="kt-menu-item"
                                                ...
                                                <div class="kt-menu-dropdown kt-menu-default w-full max-w-[175px]" data-kt-menu-dismiss="true">
                                                    @if ($class->is_active)
                                                        <div class="kt-menu-item">
                                                            <a class="kt-menu-link" href="{{ route('guru.classes.edit', $class) }}">
                                                    ...
                                                    @else
                                                        <div class="kt-menu-item">
                                                            <button type="button" class="kt-menu-link w-full text-left"
                                                                    data-kt-modal-toggle="#confirm_status_modal"
                                                                    data-action="{{ route('guru.classes.activate', $class) }}"
                                                                    data-method="PATCH"
